...
* While my initial hypothesis for a negative correlation between oil stock and gold price was proven to be correct by the regression model, the coefficient was  quite small (`y = = 1738.28 - 353X1 - 0.00021X2`, X1 being real yield (%), and X2 being oil stock (kbbl))
